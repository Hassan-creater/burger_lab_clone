...
function HeroBanner() {
	...
	*/
	...
	return (
		<CarouselContainer
		className="relative w-[95%] sm:w-full h-[15em] lg:w-full  md:h-[23em] lg:h-[28em]  xl_screens:h-[45em] 2xl_screens:h-[55em] flex justify-center    items-center overflow-hidden rounded-lg  sm:rounded-none"
		opts={{ loop: true }}
		autoplay={true}
		ref={carouselRef}
	  >
		<CarouselContent data-carousel-content>
		  {slides?.map((slide: any) => (
			<CarouselItem
			  key={slide.id}
			  className="w-screen aspect-[3000/2000] sm:aspect-[3000/1500] h-full flex items-center justify-center "
			>

...
const PromoBar = ({
  ...
  const { user , setAuthOpen , setCouponData , couponData , setCouponCode ,  setIsTaxAppliedBeforeCoupon } = useCartContext();
  ...
  const handleApplyPromo = async () => {
    ...
    try {
      ...
      setIsTaxAppliedBeforeCoupon(res.data.data.isTaxAppliedBeforeCoupon);

...
function CategoryLinkMenu({ categories  }: { categories: Category[] | null  }) {
  ...
  return (
    <nav
      className={cn(
        "sticky top-[5em]   bg-inherit z-20 mt-[1.5em] px-[2em] sm:mt-[3em] bg-[#F8F9FA]  flex items-center h-[4.8em] w-full lg:max-w-[92%] overflow-y-hidden  !focus-visible:outline-0 transition-all duration-300",
